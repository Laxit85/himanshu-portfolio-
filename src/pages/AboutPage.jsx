      ...
      <div className="about-hero-grid">
        <div>
          ...
          <p style={{ color: 'var(--ink-dim)', marginBottom: '1rem', fontSize: '1.05rem' }}>
            I’m Himanshu Srimali — a Video Editor and Graphic Designer with 2+ years crafting high-velocity digital visual content for brands, agencies, and content creators.
          </p>
          ...
          <div className="chip-cloud">
            <div className="chip-item"><span className="chip-cat">NLE:</span> Premiere Pro</div>
            <div className="chip-item"><span className="chip-cat">VFX:</span> After Effects</div>
            <div className="chip-item"><span className="chip-cat">ART:</span> Photoshop / Illustrator</div>
            <div className="chip-item"><span className="chip-cat">AUDIO:</span> Audition / Media Encoder</div>
          </div>
        </div>
